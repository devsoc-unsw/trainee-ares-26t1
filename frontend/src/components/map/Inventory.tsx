...
function InventorySidebar({ inventory, selectedTileId, onSelect }: SidebarProps) {
  return (
    <div className="w-48 shrink-0 bg-theme-brown-dark flex flex-col rounded-r-xl border-theme-brown border-t-5 border-b-5 border-r-5">
      <div className="px-3 py-2 border-b border-amber-800">
        <p className="text-theme-yellow text-xs font-semibold uppercase tracking-widest">Inventory</p>
      </div>
        ...
        {inventory.map(({ tileId, count }) => {
          ...
          return (
            ...
            >
              ...
              />
              <span className="text-amber-100 text-xs flex-1 truncate">{tile.name}</span>
      ...
      <div className="px-3 py-2 border-t border-amber-800">
        <p className="text-amber-600 text-[10px]">&#91;Click&#93; map item to move it</p>
        <p className="text-amber-600 text-[10px]">&#91;Q&#93; to store item</p>
        <p className="text-amber-600 text-[10px]">&#91;Shift + click&#93; to store item</p>
      </div>
    </div>
  );
}
