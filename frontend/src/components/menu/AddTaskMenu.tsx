...
const btnClass =
  "flex items-center rounded-xl bg-theme-brown-light text-black h-[5vh] p-3";
const activeBtnClass =
  "flex items-center rounded-xl bg-theme-yellow text-black h-[5vh] p-3";
      ...
      <div className="flex flex-col gap-3">
        ...
        {taskType === "daily" && (
          <p className="text-sm opacity-60">
            repeats every day · difficulty: easy
          </p>
        )}
